...
| Tool | Behavior |
| --- | --- |
| `create_canvas` | Canvas (`background`: `white` by default or `empty`), width/height 1..128; locks palette 24, 144 or 221 (default). Successful recreation replaces the old canvas. |
